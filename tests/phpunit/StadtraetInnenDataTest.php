...
class StadtraetInnenDataTest extends TestCase
{
    ...
    public function testParseTest()
    {
        ...
        $this->assertSame('2020-2026', $data->fraktionsMitgliedschaften[0]->wahlperiode);
        ...
        $this->assertSame('2014-2020', $data->fraktionsMitgliedschaften[1]->wahlperiode);
        ...
        $this->assertSame('2020-2026', $data->ausschussMitgliedschaften[0]->wahlperiode);
    }
}
