<?php  //[STAMP] f8678c6f4038068a625ef3c6daa49ed4
...
use Helper\HTMLValidator;
use Helper\AccessibilityValidator;
...
trait AcceptanceTesterActions
{
     ...
     * @see \Helper\HTMLValidator::validateHTML()
     */
    public function validateHTML($ignoreMessages = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('validateHTML', func_get_args()));
    }
     ...
     * @param string[] $ignoreMessages
     * @see \Helper\AccessibilityValidator::validatePa11y()
     */
    public function validatePa11y($standard = null, $ignoreMessages = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('validatePa11y', func_get_args()));
    }
}
