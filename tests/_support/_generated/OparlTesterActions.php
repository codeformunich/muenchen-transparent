<?php  //[STAMP] 91c1630e36a5bbd10413852228621a5f
...
trait OparlTesterActions
{
     ...
     *
     *
     * @see \Helper\Oparl::getResponseContent()
     */
    public function getResponseContent($json_flags = null) {
     ...
     * @see \Helper\Oparl::validateResponse()
     */
    public function validateResponse($url) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('validateResponse', func_get_args()));
    }
