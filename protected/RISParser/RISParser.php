...
abstract class RISParser
{
    ...
    abstract public function parseSeite($seite, $first);

    abstract public function parseAlle();

    abstract public function parseUpdate();

    abstract public function parseQuickUpdate();
