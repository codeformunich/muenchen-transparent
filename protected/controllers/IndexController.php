...
class IndexController extends RISBaseController
{
	...
	{
		/** @var Dokument $dokument */
		$dokument = Dokument::model()->disableDefaultScope()->findByPk($id);
		if (!$dokument) $this->render('error', array("code" => 404, "message" => "Das Dokument wurde nicht gefunden"));
		elseif ($dokument->deleted) $this->render('error', array("code" => 410, "message" => "Das Dokument wurde gelöscht"));
		else {
