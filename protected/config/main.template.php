...
return array(
	...
	'components' => array(
		...
		'urlManager'   => array(
			...
			'rules'          => array(
				RIS_BASE_URL . '/'                                                                 => 'index/index',
				RIS_BASE_URL . '/ajax-<datum_max:[0-9\-]+>'                                        => 'index/antraegeAjax',
				RIS_BASE_URL . '/ba/<ba_nr:\d+>'                                                   => 'index/ba',
				RIS_BASE_URL . '/tiles/<style:[\d@x]+>/<width:\d+>/<zoom:\d+>/<x:\d+>/<y:\d+>.png' => 'index/tileCache',
				RIS_BASE_URL . '/admin/'                                                           => 'admin/index',
				RIS_BASE_URL . '/benachrichtigungen'                                               => 'benachrichtigungen/index',
				RIS_BASE_URL . '/benachrichtigungen/alleFeed/<code:[0-9\-a-z]+>'                   => 'benachrichtigungen/alleFeed',
				RIS_BASE_URL . '/<action:\w+>'                                                     => 'index/<action>',
				RIS_BASE_URL . '/<controller:\w+>/<id:\d+>'                                         => '<controller>/anzeigen',
				RIS_BASE_URL . '/<controller:\w+>/<action:\w+>/<id:\d+>'                            => '<controller>/<action>',
				RIS_BASE_URL . '/<controller:\w+>/<action:\w+>'                                     => '<controller>/<action>',
			),
		),
		'db'           => array(
