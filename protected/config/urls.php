...
$GLOBALS["RIS_URL_RULES"] = [
    ...
    SITE_BASE_URL . '/oparl'                                            => 'oparl/system',
    SITE_BASE_URL . '/oparl/body/<body:\d+>'                            => 'oparl/body',
    SITE_BASE_URL . '/oparl/body'                                       => 'oparl/bodyList',
    SITE_BASE_URL . '/oparl/body/<body:\d+>/paper/<paper:\d+>'          => 'oparl/paper',
    SITE_BASE_URL . '/oparl/body/<body:\d+>/paper'                      => 'oparl/paperList',
