...
$GLOBALS["RIS_URL_RULES"] = [
    ...
    SITE_BASE_URL . '/oparl/v1.0'                                         => 'oparl/system',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>'                         => 'oparl/body',
    SITE_BASE_URL . '/oparl/v1.0/body'                                    => 'oparl/bodyList',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/term/<term:\d+>'         => 'oparl/term',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/term'                    => 'oparl/termList',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/paper/<paper:\d+>'       => 'oparl/paper',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/paper'                   => 'oparl/paperList',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/meeting/<meeting:\d+>'   => 'oparl/meeting',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/meeting'                 => 'oparl/meetingList',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/organization/<orga:\d+>' => 'oparl/organization',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/organization'            => 'oparl/organizationList',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/person/<person:\d+>'     => 'oparl/person',
    SITE_BASE_URL . '/oparl/v1.0/body/<body:\d+>/person'                  => 'oparl/personList',
