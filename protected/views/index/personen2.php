...
$personen_typ_name = ($personen_typ == 'str' ? 'StadträtInnen' : 'Bezirksausschuss-Mitglieder');
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <?
                                $str_link = Yii::app()->createUrl("index/personen2");
                                if ($ba_nr === null) echo '<li class="active"><a href="' . CHtml::encode($str_link) . '">Stadtrat <span class="sr-only">(aktuell)</span></a></li>';
                                else echo '<li><a href="' . CHtml::encode($str_link) . '">Stadtrat</a></li>';

                                foreach ($bas as $ba) {
                                    $str_link = Yii::app()->createUrl("index/personen2", array("ba" => $ba->ba_nr));
        ...
        <div class="col-sm-9">
            ...
            <div class="filter_sorter_holder<? if (count($fraktionen) > 7) echo " extrabreit"; ?>">
                <div class="btn-group filter_widget" data-toggle="buttons">
                    <label class="btn btn-primary btn-separator-right active">
                    ...
                    if ($facebook) {
                        ?>
                        <label class="btn btn-primary active btn-separator-left">
            ...
            <ul class="strIn_liste">
                ...
                foreach ($stadtraetInnen as $strIn) {
                    ...
                    if ($strIn->abgeordnetenwatch != "") echo "<a href='" . CHtml::encode($strIn->abgeordnetenwatch) . "' title='Abgeordnetenwatch' class='abgeordnetenwatch_link'></a>";
                    ...
                    echo '</div>';
                    echo '<div class="name" data-vorname="' . CHtml::encode($strIn->errateVorname()) . '"';
                    echo ' data-nachname="' . CHtml::encode($strIn->errateNachname()) . '">' . CHtml::encode($strIn->getName()) . '</div>';
            ...
            <script>
                $(function () {
                    ...
                    $filter.find("input").change(function () {
                        ...
                        else if (val == "twitter" || val == "facebook") $liste.isotope({filter: "." + val});
