...
<a href="#" onClick="return index_aeltere_dokumente_load('<?=CHtml::encode($this->createUrl("index/antraegeAjaxDatum", array("datum_max" => $datum_pre)))?>');"><span class="glyphicon glyphicon-chevron-right"></span> Ältere Dokmente</a>
</div>