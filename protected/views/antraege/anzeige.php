				...
				<tr>
					...
					<td><?
						...
						<?
							...
							?>
							<form method="POST" action="<?= CHtml::encode($antrag->getLink(array("tag_mode" => 1))) ?>" style="display: inline;">
								<?
								$this->renderPartial("../index/login_modal");
								?>
								&nbsp; &nbsp;
								<a href="#tag_add_form" data-toggle="modal" data-target="#benachrichtigung_login"><span class="glyphicon glyphicon-chevron-down"></span> Neue
									hinzufügen (Login)</a>
							</form>
						<?
						}
