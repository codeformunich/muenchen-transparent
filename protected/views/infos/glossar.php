...
?>
	<h2>Glossar</h2>
	<a href="<?= CHtml::encode(Yii::app()->createUrl("infos/soFunktioniertStadtpolitik")) ?>"><span class="glyphicon glyphicon-arrow-left"></span> Zurück</a><br>


	<br>
	<br>

	<dl class="glossar dl-horizontal well" style="max-width: 850px; margin-left: auto; margin-right: auto;">
		<?
