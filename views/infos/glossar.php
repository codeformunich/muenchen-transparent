...
<section class="well">
	<ul class="breadcrumb" style="margin-bottom: 5px;">
		...
		<li><a href="<?= Html::encode(Url::to("infos/soFunktioniertStadtpolitik")) ?>">So funktioniert Stadtpolitik</a><br></li>
	...
	if ($this->context->binContentAdmin()) {
		...
		<form method="POST" action="<?= Html::encode(Url::to("infos/glossar")) ?>" role="form" class="well"
