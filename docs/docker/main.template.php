...
define("SITE_BASE_URL", "http://docker:8080");
...
define("PATH_TESSERACT", "/usr/bin/tesseract");
define("PATH_JAVA", "/usr/bin/java");
define("PATH_PDFTOTEXT", "/usr/bin/pdftotext");
define("PATH_PDFBOX", "/opt/pdfbox-app-1.8.10.jar");
...
return [
    ...
    'components'     => [
        ...
        'db'           => [
            'connectionString'      => 'mysql:host=database;dbname=muctransparent',
            'emulatePrepare'        => true,
            'username'              => 'ris',
            'password'              => 'sec',
            'charset'               => 'utf8mb4',
